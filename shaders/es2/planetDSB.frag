...
{
    // Reflexión de la dirección de la luz sobre la normalidad
...
void main()
{
    ...
    // Muestra las texturas en los texCoords interpolados
    ...
    // Combina spec con ambient + diffuse para el color del fragmento final
